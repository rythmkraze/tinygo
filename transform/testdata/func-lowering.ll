...
@"reflect/types.type:func:{basic:uint8}{}$funcid" = external constant i8
@"reflect/types.type:func:{basic:int}{}$funcid" = external constant i8
@"reflect/types.type:func:{}{basic:uint32}$funcid" = external constant i8
@"func1Uint8$withSignature" = constant %runtime.funcValueWithSignature { i32 ptrtoint (void (i8, i8*, i8*)* @func1Uint8 to i32), i8* @"reflect/types.type:func:{basic:uint8}{}$funcid" }
@"func2Uint8$withSignature" = constant %runtime.funcValueWithSignature { i32 ptrtoint (void (i8, i8*, i8*)* @func2Uint8 to i32), i8* @"reflect/types.type:func:{basic:uint8}{}$funcid" }
@"main$withSignature" = constant %runtime.funcValueWithSignature { i32 ptrtoint (void (i32, i8*, i8*)* @"main$1" to i32), i8* @"reflect/types.type:func:{basic:int}{}$funcid" }
@"main$2$withSignature" = constant %runtime.funcValueWithSignature { i32 ptrtoint (void (i32, i8*, i8*)* @"main$2" to i32), i8* @"reflect/types.type:func:{basic:int}{}$funcid" }
...
entry:
  %2 = call i32 @runtime.getFuncPtr(i8* %0, i32 %1, i8* @"reflect/types.type:func:{}{basic:uint32}$funcid", i8* undef, i8* null)
...
entry:
  %3 = call i32 @runtime.getFuncPtr(i8* %0, i32 %1, i8* @"reflect/types.type:func:{basic:uint8}{}$funcid", i8* undef, i8* null)
...
entry:
  %2 = call i32 @runtime.getFuncPtr(i8* %0, i32 %1, i8* @"reflect/types.type:func:{basic:int}{}$funcid", i8* undef, i8* null)
